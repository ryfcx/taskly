...
Daily, weekly, or one-off. Categories + difficulty set the XP (Trivial → Ultra). Ultra is for stuff that eats most of the day. Optional reminders. Can start today, tomorrow, or a custom date.
